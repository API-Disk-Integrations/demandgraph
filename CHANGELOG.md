...
- Base URL is `https://demandgraph-api.com`. A client generated from an earlier copy of this contract points elsewhere and must be regenerated.
...
- Plans published. Billed per scored topic.

| Plan | Per month | Included scored topics | Additional | Overage cap |
| --- | --- | --- | --- | --- |
| Developer | $249 | 5,000 | $0.08 each | $500 |
| Growth | $999 | 30,000 | $0.05 each | $2,000 |
| Scale | $2,499 | 100,000 | $0.03 each | $5,000 |
| Enterprise | $5,000 | 300,000 | $0.02 each | $10,000 |
...
- First published contract, 8 operations:
  ...
  - `POST /v1/scores` — Score and rank topics by demand momentum
  - `POST /v1/demo/score` — Public demo — scores one topic without a key (no API key required)
  - `GET /v1/weights` — The default source weights, and why they differ (no API key required)
...
- Free sandbox keys allow 50 scored topics per period, no card required.
